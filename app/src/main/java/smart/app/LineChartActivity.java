...
////                            sensorbean = HttpService.JsonToObject(message, Sensorbean.class);
//                        } catch (Exception e) {
//                            e.printStackTrace();
//                        }
...
//        @Override
//        public void run() {
////            txt_topbar.setText(sensorbean.data.Name);
////            Float f = Float.parseFloat(sensorbean.data.Value);
////            addEntry(f, sensorbean.data.Name, sensorbean.data.Unit);
//        }
//    };
//
//    // 添加进去一个坐标点
